                                ...
                                @foreach($education as $edu)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            {{$edu->created_at->diffForHumans()}}
                                        </td>
                                        @can('admin')
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex item-center justify-center">
                                                    <a href="{{ route('admin.education.edit', $edu->id) }}" class="mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    ...
                                                    <span @click="modal = true; route = '{{route('admin.education.destroy', $edu->id)}}'" class="cursor-pointer mr-2 transform hover:text-purple-500 hover:scale-110">
                                                        <svg class="w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
