                                        ...
                                        @can('admin')
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex item-center justify-center">
                                                    @can('alter-profile', $user)
                                                        <a href="{{ route('admin.user.edit', $user->id) }}" class="mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    ...
                                                    @endcan
                                                    @can('admin')
                                                        <span @click="modal = true; route = '{{route('admin.user.destroy', $user->id)}}'" class="cursor-pointer mr-2 transform hover:text-purple-500 hover:scale-110">
                                                            <svg class="w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
